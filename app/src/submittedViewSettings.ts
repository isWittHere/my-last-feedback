...
export const SUBMITTED_VIEW_SECTION_CONFIGS: SubmittedViewSectionConfig[] = [
  ...
  { id: "commandLogs", labelKey: "settings.submittedSectionCommandLogs", defaultLabel: "Attachment: Command Logs" },
  { id: "mlcReferences", labelKey: "settings.submittedSectionMlcReferences", defaultLabel: "Attachment: MLC References" },
