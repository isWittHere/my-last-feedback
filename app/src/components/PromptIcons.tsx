/**
 * Preset icon library for prompt buttons.
 * Users specify `icon: "book"` in YAML front matter.
 * Each entry is a Lucide-style SVG (24x24 viewBox, stroke-based).
 * Returns null if icon name is not found.
 */
...
const ICONS: Record<string, IconDef> = {
  ...
  brain: {
    viewBox: "0 0 24 24",
    paths: '<path d="M12 2a7 7 0 0 0-7 7c0 2.38 1.19 4.47 3 5.74V17a2 2 0 0 0 2 2h4a2 2 0 0 0 2-2v-2.26c1.81-1.27 3-3.36 3-5.74a7 7 0 0 0-7-7z"/><line x1="9" y1="21" x2="15" y2="21"/>',
  },
  lightbulb: {
    viewBox: "0 0 24 24",
  ...
  wand: {
    viewBox: "0 0 24 24",
    paths: '<path d="M15 4V2"/><path d="M15 16v-2"/><path d="M8 9h2"/><path d="M20 9h2"/><path d="M17.8 11.8L19 13"/><path d="M15 9h0"/><path d="M17.8 6.2L19 5"/><path d="m3 21 9-9"/><path d="M12.2 6.2L11 5"/>',
  },
  sparkles: {
    viewBox: "0 0 24 24",
  ...
  bug: {
    viewBox: "0 0 24 24",
    paths: '<rect width="8" height="14" x="8" y="6" rx="4"/><path d="m19 7-3 2"/><path d="m5 7 3 2"/><path d="m19 19-3-2"/><path d="m5 19 3-2"/><path d="M20 13h-4"/><path d="M4 13h4"/><path d="m10 4 1 2"/><path d="m14 4-1 2"/>',
  },
  summary: {
    viewBox: "0 0 24 24",
...
export function PromptIcon({ name, size = 11 }: { name: string; size?: number }) {
...
export function hasPromptIcon(name: string): boolean {
