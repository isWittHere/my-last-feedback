...
class MainActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        // 根据明暗模式设置状态栏前景颜色 (JS 可通过 MlfbBridge.setTheme 覆盖)
        ...
        // 注册 JS 桥: JS 可通过 window.MlfbBridge.exitApp() 主动退出
        webView.addJavascriptInterface(NativeBridge(this), "MlfbBridge")
